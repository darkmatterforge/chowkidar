...
- Automated security rebuild
  - **Fixed CVEs:** none
  - **OS packages updated:**
  - docker-cli-29.7.1-r0 → docker-cli-29.7.2-r0
  - python-3.13-3.13.14-r3 → python-3.13-3.13.15-r0
  - python-3.13-base-3.13.14-r3 → python-3.13-base-3.13.15-r0
...
- Automated security rebuild
  - **Fixed CVEs:** none
  - **OS packages updated:**
  - py3-pip-wheel-26.2-r0 → py3-pip-wheel-26.2.1-r0
  - py3.13-pip-26.2-r0 → py3.13-pip-26.2.1-r0
  - py3.13-pip-base-26.2-r0 → py3.13-pip-base-26.2.1-r0
  - **Trigger:** 3 package(s) updated
...
- Automated security rebuild
  - **Fixed CVEs:** none
  - **OS packages updated:**
  - docker-cli-29.6.2-r1 → docker-cli-29.7.0-r0
  - libnghttp2-14-1.69.0-r0 → libnghttp2-14-1.70.0-r0
  - py3-pip-wheel-26.1.2-r1 → py3-pip-wheel-26.2-r0
  - py3.13-pip-26.1.2-r1 → py3.13-pip-26.2-r0
  - py3.13-pip-base-26.1.2-r1 → py3.13-pip-base-26.2-r0
  - **Trigger:** 5 package(s) updated
...
- Automated security rebuild
  - **Fixed CVEs:** none
  - **OS packages updated:**
  - ncurses-6.6.20260718-r0 → ncurses-6.6.20260725-r0
  - ncurses-terminfo-base-6.6.20260718-r0 → ncurses-terminfo-base-6.6.20260725-r0
  - nghttp3-1.17.0-r0 → nghttp3-1.18.0-r0
  - ngtcp2-1.24.0-r0 → ngtcp2-1.25.0-r0
  - **Trigger:** 4 package(s) updated
...
- Automated security rebuild
  - **Fixed CVEs:** none
  - **OS packages updated:**
  - docker-cli-29.6.2-r0 → docker-cli-29.6.2-r1
  - python-3.13-3.13.14-r2 → python-3.13-3.13.14-r3
  - python-3.13-base-3.13.14-r2 → python-3.13-base-3.13.14-r3
  - sqlite-libs-3.53.3-r1 → sqlite-libs-3.53.4-r0
  - **Trigger:** 4 package(s) updated
...
- Automated security rebuild
  - **Fixed CVEs:** none
  - **OS packages updated:**
  - ncurses-6.6.20260711-r0 → ncurses-6.6.20260718-r0
  - ncurses-terminfo-base-6.6.20260711-r0 → ncurses-terminfo-base-6.6.20260718-r0
  - **Trigger:** 2 package(s) updated
...
- Automated security rebuild
  - **Fixed CVEs:** none
  - **OS packages updated:**
  - libffi-3.7.0-r0 → libffi-3.7.1-r0
  - python-3.13-3.13.14-r0 → python-3.13-3.13.14-r1
  - python-3.13-base-3.13.14-r0 → python-3.13-base-3.13.14-r1
  - **Trigger:** 3 package(s) updated
...
- Automated security rebuild
  - **Fixed CVEs:** CVE-2026-39822,CVE-2026-42505
  - **OS packages updated:**
  - docker-cli-29.6.1-r0 → docker-cli-29.6.1-r1
  - dumb-init-1.2.5-r11 → dumb-init-1.2.5-r12
  - libffi-3.6.0-r2 → libffi-3.7.0-r0
  - **Trigger:** 3 package(s) updated; fixed 8 CVE(s)
...
- Automated security rebuild
  - **Fixed CVEs:** none
  - **OS packages updated:**
  - curl-8.20.0-r2 → curl-8.21.0-r0
  - glibc-2.43-r8 → glibc-2.43-r9
  - glibc-locale-posix-2.43-r8 → glibc-locale-posix-2.43-r9
  - ld-linux-2.43-r8 → ld-linux-2.43-r9
  - libcrypt1-2.43-r8 → libcrypt1-2.43-r9
  - libcurl-openssl4-8.20.0-r2 → libcurl-openssl4-8.21.0-r0
  - libpsl-0.21.5-r8 → libpsl-0.22.0-r1
  - **Trigger:** wolfi-base updated; 7 package(s) updated
...
- Automated rebuild: 1 package(s) updated
  - **Updated packages:**
  - heimdal-libs-7.8.0-r48 → heimdal-libs-7.8.0-r49
...
[0.5.16]: https://github.com/darkmatterforge/chowkidar/compare/v0.5.15...v0.5.16
